...
using namespace std;
const std::string basePath = "C:/Users/dzhda/OneDrive/Ðàáî÷èé ñòîë/ïîëèòåõ/×èñëåííûå ìåòîäû/3 ñåì/lab 4/Numercial Methods lab 6 matrix generation/Numercial Methods lab 6 matrix generation/matrices_output_modified/";
...
void chekFile(const std::string& filename) {
    try {
        ...
        // Óñòàíîâêà ôèêñèðîâàííîãî ôîðìàòà âûâîäà è òî÷íîñòè
